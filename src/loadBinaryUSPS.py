...
def load_binary(D1,D2,reduce=False):
    ...
    file_path = os.path.abspath(os.path.join(path,'/Users/georgezervakis/Desktop/RVM/usps_resampled.m'))
    # data = scipy.io.loadmat(path)
    dat = np.loadtxt('/Users/georgezervakis/Desktop/RVM/usps_resampled.m')
